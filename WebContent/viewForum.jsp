...
<body data-spy="scroll" data-target="#navbarResponsive" class="body">
	...
	<div id="home">
		<div>
			<img id="forum_background" src="img/image.jpg">
	...
	<div class="narrow text-center" >
		...
		<!-- Start Forum for Comment Submit -->
		...
		%>
				...
				<table><tr><th>UserName</th><th colspan="8"> Comment</th></tr>
	...
	<!--End Animation -->
		...
		<div class="narrow text-center"></div>
